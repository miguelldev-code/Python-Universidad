"""
Enunciado:
Una tienda tiene una lista de productos disponibles. Cada vez que se vende un producto, debe ser eliminado de la lista. El proceso se repite hasta que el usuario escriba "fin". Al final, se muestra el stock restante.
